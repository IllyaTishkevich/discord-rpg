...
class BattleController extends AbstractApiController
{
    ...
    #[Route('/{id}/rounds', name: 'battle_play_round', methods: ['POST'])]
    public function playRound(Battle $battle, Request $request, BattleService $battleService): JsonResponse
    {
        $this->assertOwnership($battle);
        ...
        try {
            $round = $battleService->playRound($battle, array_map('intval', $actionTargets));

...
Реализованы Sprint 0–7 из `docs/ROADMAP.md` (инфраструктура, аккаунты, боевое ядро, Activity-визуализация, бот, магазин, ивенты, турниры и задания) плюс `/leaderboard` и админка на EasyAdmin. Не сделано и требует действий за пределами кода:
